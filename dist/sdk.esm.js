...
import IUniswapV2Pair from '@swoop-exchange/core/build/contracts/IUniswapV2Pair.json';
...
})(Rounding || (Rounding = {})); // Testnet address: local: 0x0bFBe6255ef2f329e6E6400a01172413E69682c6 - deployed 2020-10-30 16:10 UTC
// Mainnet address: 0x7e4187406BF18eB6Bf479f33fb99bC7c22c0A0Fc - final Mainnet deployment


var FACTORY_ADDRESS = '0x7e4187406BF18eB6Bf479f33fb99bC7c22c0A0Fc'; // Original Uniswap code hash: 0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f
...
var INIT_CODE_HASH = '0xe9574de88b7d368ba596b539348788fc220a090ef49838cd2004164f36680c18';
...
Currency.HARMONY = /*#__PURE__*/new Currency(18, 'ONE', 'Harmony');
...
var WONE = (_WONE = {}, _WONE[ChainID.HmyMainnet] = /*#__PURE__*/new Token(ChainID.HmyMainnet, '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a', // deployed 2020-10-20 12:42 UTC
18, 'WONE', 'Wrapped ONE'), _WONE[ChainID.HmyTestnet] = /*#__PURE__*/new Token(ChainID.HmyTestnet, '0xfa984D5ba661DC0e30639022f0AfEAF65c8A5CBa', // deployed 2020-10-20 12:42 UTC
18, 'WONE', 'Wrapped ONE'), _WONE);
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  CurrencyAmount.ether = function ether(amount) {
    return new CurrencyAmount(HARMONY, amount);
  };
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'SWP', 'Swoop');
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === HARMONY && pairs[0].involvesToken(WONE[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === HARMONY && pairs[pairs.length - 1].involvesToken(WONE[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === HARMONY ? CurrencyAmount.ether(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === HARMONY ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var etherIn = trade.inputAmount.currency === HARMONY;
    var etherOut = trade.outputAmount.currency === HARMONY; // the router does not support both ether in and out
    ...
    var to = validateAndParseAddress(options.recipient); // For @harmony-js/core numbers have to be submitted as strings and not in hex format
    ...
    var deadline = BigNumber.from("0x" + (Math.floor(new Date().getTime() / 1000) + options.ttl).toString(16)).toString();
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[ChainID.HmyMainnet] = {
...
export { Currency, CurrencyAmount, FACTORY_ADDRESS, Fetcher, Fraction, HARMONY, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WONE, currencyEquals, inputOutputComparator, tradeComparator };
