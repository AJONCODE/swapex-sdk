...
var IUniswapV2Pair = _interopDefault(require('@swoop-exchange/core/build/contracts/IUniswapV2Pair.json'));
...
})(exports.Rounding || (exports.Rounding = {})); // Testnet address: local: 0x0bFBe6255ef2f329e6E6400a01172413E69682c6 - deployed 2020-10-30 16:10 UTC
...
var WONE = (_WONE = {}, _WONE[utils.ChainID.HmyMainnet] = /*#__PURE__*/new Token(utils.ChainID.HmyMainnet, '0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a', // deployed 2020-10-20 12:42 UTC
18, 'WONE', 'Wrapped ONE'), _WONE[utils.ChainID.HmyTestnet] = /*#__PURE__*/new Token(utils.ChainID.HmyTestnet, '0xfa984D5ba661DC0e30639022f0AfEAF65c8A5CBa', // deployed 2020-10-20 12:42 UTC
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === HARMONY && pairs[0].involvesToken(WONE[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === HARMONY && pairs[pairs.length - 1].involvesToken(WONE[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === HARMONY ? CurrencyAmount.ether(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === HARMONY ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    var deadline = bignumber.BigNumber.from("0x" + (Math.floor(new Date().getTime() / 1000) + options.ttl).toString(16)).toString();
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[utils.ChainID.HmyMainnet] = {
